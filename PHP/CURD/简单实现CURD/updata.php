...
?>  
    ...
    <form action="updata.php" method="post">
        ...
        <label for="name">用户名：&nbsp;</label><input type="text" name="name" value="<?php echo $row['name']; ?>"><br>
        <label for=name="password">密&nbsp;&nbsp;&nbsp;&nbsp;码：</label><input type="password" name="password" value="<?php echo $row['password']; ?>"><br>
        <label for="email">邮&nbsp;&nbsp;&nbsp;&nbsp;箱：</label><input type="text" name="email" value="<?php echo $row['email']; ?>"><br>
